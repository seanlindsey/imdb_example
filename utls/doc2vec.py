...
from utls.word2vec import Word2Vec, Vocab, train_cbow_pair, train_sg_pair


try:
    from utls.doc2vec_inner import train_sentence_dbow, train_sentence_dm, FAST_VERSION
except ImportError:
    try:
